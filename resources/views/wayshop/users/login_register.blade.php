             ...
             <div class="contact-form-right">
                 ...
                 <form action="{{url('/user-register')}}" method="POST" id="contactForm registerForm"> {{csrf_field()}}
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Password" id="password-field2" name="password" required data-error="Please Enter Your Password">
            ...
            <div class="contact-form-right">
                ...
                <form action="{{url('/user-login')}}" method="post" id="contactForm LoginForm"> {{csrf_field()}}
                    <div class="row"> 
                       ...
                       <div class="col-md-12">
                           <div class="form-group">
                               <input type="password" class="form-control" placeholder="Password" id="password-field" name="password" required data-error="Please Enter Your Password">
