                    ...
                    <div class="product-categori">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                <div class="list-group-collapse sub-men">
                                    {{-- <a class="list-group-item list-group-item-action" href="#{{$cat->id}}" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{$cat->name}} <small class="text-muted"></small> --}}
                                        <a href="{{url('/occasions/'.$cat->slug)}}" class="list-group-item list-group-item-action">{{$cat->name}}</a>
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                <div class="list-group-collapse sub-men">
                                    {{-- <a class="list-group-item list-group-item-action" href="#{{$cat->id}}" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{$cat->name}} <small class="text-muted"></small> --}}
                                    <a class="list-group-item list-group-item-action" href="{{url('/types/'.$cat->slug)}}" >{{$cat->name}} <small class="text-muted"></small>
