             ...
             <div class="panel panel-bd lobidrag">
                ...
                <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                   <div class="btn-group">
                      ...
                      <a class="btn btn-add" href="{{url('admin/add-occasion')}}"> <i class="fa fa-plus"></i> Add Category
                         </a>  
                      </div>
                         ...
                         <tbody>
                            ...
                            <td>
                              ...
                              <div id="myElem" style="display:none;" class="alert alert-success">Status Enabled</div>
                               ...
                               <td>
                               <a href="{{url('/admin/edit-occasion/'.$occasion->slug)}}" class="btn btn-add btn-sm"><i class="fa fa-pencil"></i></button>
                               <a href="{{url('/admin/delete-occasion/'.$occasion->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> </button>
                               </td>
                            </tr>
                             @endforeach
                         </tbody>
