         ...
         <div class="navbar-custom-menu">
              <ul class="nav navbar-nav">
                 ...
                 <li class="dropdown notifications-menu">
                    ...
                    <span class="label label-warning">{{count(Session::get('newOrders'))}}</span>
                    </a>
                    <ul class="dropdown-menu">
                       <li>
                          <ul class="menu">
                             ...
                             <li>
                                <a href="{{url('/admin/orders')}}" class="border-gray">
                 ...
                 <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu" >
                        ...
                        @else
                           ...
                           @endif --}}
                           <li>
                              <a href="{{url('/admin/florist-profile')}}">
                              <i class="fa fa-user"></i> User Store</a>
                           </li> 
                           <li><a href="{{url('/florist-logout')}}">
                              <i class="fa fa-sign-out"></i> Sign out</a>
                           </li>
                        @endif
                    </ul>
