       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" action="{{url('/admin/edit-type/'.$typeDetails->slug)}}" method="post"> {{csrf_field()}}
                      <div class="form-group">
                         <label>Type Name</label>
                      <input type="text" class="form-control" value="{{$typeDetails->name}}" name="type_name" id="type_name" required>
                      </div>
                      <div class="form-group">
