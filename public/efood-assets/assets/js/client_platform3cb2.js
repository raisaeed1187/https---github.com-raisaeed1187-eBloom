...
*/
    ...
    var Ta = function (a) {
            if (a instanceof x && a.constructor === x && a.da === Sa)
                return a.S;
    ...
    var Va = function (a) {
            if (a instanceof y && a.constructor === y) return a.P;
            xa(
        ...
        Xa = function (a) {
            ...
            wa(Wa.test(a), "%s does not match the safe URL pattern", a) ||
    ...
    var Za = function (a) {
        ...
        Ya = {},
        $a = new B((p.trustedTypes && p.trustedTypes.emptyHTML) || "", 0, Ya);
    ...
    var db = -1 != w.indexOf("Opera"),
        eb = -1 != w.indexOf("Trident") || -1 != w.indexOf("MSIE"),
        fb = -1 != w.indexOf("Edge"),
        gb =
            -1 != w.indexOf("Gecko") &&
            !(
            ...
            -1 == w.indexOf("Edge"),
        hb = -1 != w.toLowerCase().indexOf("webkit") && -1 == w.indexOf("Edge"),
        ib = function () {
            var a = p.document;
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var K = function (a, b, c) {
        ...
        Wb = function (a, b) {
            ...
            c.i.length && (b += "#" + c.i.join(""));
            b = new y(b, Ua);
            Da(a, "HTMLAnchorElement");
            b = b instanceof y ? b : Xa(b);
            a.href = Va(b);
            e.appendChild(a);
            b = e.innerHTML;
            c = new x(Ra, "Assignment to self.");
            ya(Ta(c), "must provide justification");
            wa(
                !/^[\s\xa0]*$/.test(Ta(c)),
                "must provide non-empty justification"
            );
            void 0 === Qa && (Qa = sa("gapi#html"));
            b = (c = Qa) ? c.createHTML(b) : b;
            b = new B(b, null, Ya);
    ...
    var nc = function (a, b, c) {
        ...
        pc = function (a, b, c) {
            b &&
                0 < b.length &&
                ((b = oc(b)),
                c && 0 < c.length && (b += "___" + oc(c)),
                28 < b.length && (b = b.substr(0, 28) + (b.length - 28)),
                (c = b),
                (b = E(mc, "_p", F())),
                (E(b, c, F())[a] = new Date().getTime()),
                nc(a, "_p", c));
        },
        oc = function (a) {
            return a
    ...
    var sc = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Bc = function (a) {
            ...
            c = 0;
            for (d = tc.length; c < d; ++c)
                tc[c].test(b) && N("invalid_prefix");
            c = Ec(a, "k", !0);
            d = Ec(a, "am");
            e = Ec(a, "rs");
            a = Ec(a, "t");
    ...
    var Gc = decodeURI("%73cript"),
        ...
        Kc = function (a) {
            ...
            b.async = "true";
            (a = D.getElementsByTagName(Gc)[0])
                ? a.parentNode.insertBefore(b, a)
                : (D.head || D.body || D.documentElement).appendChild(b);
        },
        Nc = function (a, b) {
            var c = b && b._c;
            if (c)
    ...
    var kd = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        ...
        md = function (a) {
            ...
            null == b &&
                ...
                (b = K(a, "authuser") || null),
                null == b && (b = (b = a.match(kd)) ? b[1] : null));
        ...
        nd = function (a) {
            ...
            null == b &&
                (b = (a = (a || window.location.href).match(ld)) ? a[1] : null);
            if (null == b) return null;
            b = String(b);
            21 < b.length && (b = null);
            return b;
    ...
    var od,
        ...
        Pd = function (a) {
            if (-1 !== T)
                return Nd(), U ? p.JSON.stringify.call(p.JSON, a) : X(a);
        },
        Qd =
    ...
    Td.prototype.digest = function () {
        ...
        56 > this.v
            ...
            : this.update(this.H, this.l - (this.v - 56));
        for (var c = this.l - 1; 56 <= c; c--)
            (this.L[c] = b & 255), (b /= 256);
        Ud(this, this.L);
        for (c = b = 0; 5 > c; c++)
            for (var d = 24; 0 <= d; d -= 8)
                (a[b] = (this.g[c] >> d) & 255), ++b;
        return a;
    };
    var Vd = function () {
        this.R = new Td();
        ...
        me = function (a, b, c, d, e) {
            ...
            try {
                document.all &&
                    (f = a.createElement(
                        '<iframe frameborder="' +
                            Jb(String(c.frameborder)) +
                            '" scrolling="' +
                            Jb(String(c.scrolling)) +
                            '" ' +
                            h +
                            ' name="' +
                            Jb(String(c.name)) +
                ...
                f ||
                    ((f = (a ? new yb(xb(a)) : ta || (ta = new yb())).ga(
                        "IFRAME"
                    )),
                    g &&
                        ((f.onload = function () {
            ...
            for (var k in c)
                (a = c[k]),
                    "style" === k && "object" === typeof a
                        ? H(a, f.style)
                        : je[k] || f.setAttribute(k, String(a));
    ...
    var Me = function (a, b) {
        ...
        Le = function (a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                h &&
                    (Ke[h] ||
                        ...
                        0 != Kb(Ce(g)).length) &&
                    (g.setAttribute("data-gapiscan", !0), E(c, h, []).push(g));
            }
            if (b)
                for (var u in c)
            ...
            if (Ne(Ie || {}))
                ...
                d = [];
                for (z in c)
                    for (a = c[z], q = 0, b = a.length; q < b; q++)
                        (e = a[q]), Pe(z, e, Ce(e), d, b);
                Qe(u, d);
            }
        },
        Re = function (a) {
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        ne.test(b) &&
                            ...
                            I(!!e, "Unknown iframe url config for - " + b));
                        ...
                        !t &&
                            q &&
                            ((q =
                                K(b.location.href, "_gfid", "") ||
                                K(b.location.href, "id", "")),
                            (t = K(b.location.href, "pfname", "")),
                            (t = q ? t + "/" + q : ""));
                        t ||
                            ((q = Od(K(b.location.href, "jcp", ""))) &&
                                "object" == typeof q &&
                                (t = (t = q.id) ? q.pfname + "/" + t : ""));
                        u.pfname = t;
                        k.connectWithJsonParam &&
                            ((q = {}), (q.jcp = Pd(u)), (u = q));
                        ...
                        if (h.forcePost || (f && 2e3 < l.length)) {
                            ...
                            e = l instanceof y ? l : Xa(l);
                            Da(f, "HTMLFormElement").action = Va(e);
            ...
            function d(f) {
                ...
                if (bf(g, b)) {
                    ...
                    cf(a, function () {
                        k && M("rqd");
                        c();
                        for (var l = E(L, "RPMQ", []), m = 0; m < l.length; m++)
                            l[m]({ data: g, origin: h });
                    });
                }
            }
    ...
    function mf(a) {
        ...
        d = "E" === c && e.j;
        return (!d && ("U" !== c || e.j)) || (d && !hf)
            ? b
            : { X: !0, j: d, la: a.substr(1), domain: e.domain, o: e.o };
    }
    var nf = function (a) {
            if (!a) return [];
            a = a.split("=");
    ...
    n.Z = function () {
        this.M &&
            ...
            window.setTimeout(pa(this.Z, this), 1e3 * this.A));
    };
    n.A = 0;
    n.T = 2;
    n.V = null;
...
gapi.load("client", {
    callback: window["googleSignInStart"],
    _c: {
        jsl: {
            ci: {
                deviceType: "desktop",
            ...
            h:
                "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US._62Wsnwv-UM.O/am\u003dwQ/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCP3ho00qv2vB9ExGbDMGLpNMMv4Vw/m\u003d__features__",
            u:
                "https://apis.google.com/js/client:platform.js?onload\u003dgoogleSignInStart",
            hee: true,
            fp: "5637dc7443f6f51bddbf8d9973cb8b37f9c84fee",
            dpo: false,
        },
        platform: [
            "additnow",
